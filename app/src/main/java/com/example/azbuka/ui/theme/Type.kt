...
val FinalScreenTitleTextStyle = TextStyle(
    fontFamily = SfProText,
    fontWeight = FontWeight.SemiBold,
    fontSize = 20.sp
)

val FinalScreenSubtitleTextStyle = TextStyle(
    fontFamily = SfProText,
    fontWeight = FontWeight.SemiBold,
    fontSize = 16.sp
)

val FinalScreenProgressTextStyle = TextStyle(
    fontFamily = SfProText,
    fontWeight = FontWeight.Bold,
    fontSize = 32.sp
)
...
val RatingScreenWeeklySummaryTitleTextStyle = TextStyle(
    fontWeight = FontWeight.Medium,
    fontSize = Title20
)

val RatingScreenBodyBoldTextStyle = TextStyle(
